...
public struct CreateReviewInput: GraphQLMapConvertible {
  ...
  public init(id: GraphQLID? = nil, user: String, recipeId: GraphQLID, content: String, image: String, createdAt: String? = nil, updatedAt: String? = nil) {
    graphQLMap = ["id": id, "user": user, "recipeID": recipeId, "content": content, "image": image, "createdAt": createdAt, "updatedAt": updatedAt]
  }
...
public struct ModelReviewConditionInput: GraphQLMapConvertible {
  ...
  public init(user: ModelStringInput? = nil, recipeId: ModelIDInput? = nil, content: ModelStringInput? = nil, image: ModelStringInput? = nil, createdAt: ModelStringInput? = nil, updatedAt: ModelStringInput? = nil, and: [ModelReviewConditionInput?]? = nil, or: [ModelReviewConditionInput?]? = nil, not: ModelReviewConditionInput? = nil) {
    graphQLMap = ["user": user, "recipeID": recipeId, "content": content, "image": image, "createdAt": createdAt, "updatedAt": updatedAt, "and": and, "or": or, "not": not]
  }
...
public struct UpdateReviewInput: GraphQLMapConvertible {
  ...
  public init(id: GraphQLID, user: String? = nil, recipeId: GraphQLID? = nil, content: String? = nil, image: String? = nil, createdAt: String? = nil, updatedAt: String? = nil) {
    graphQLMap = ["id": id, "user": user, "recipeID": recipeId, "content": content, "image": image, "createdAt": createdAt, "updatedAt": updatedAt]
  }
...
public struct ModelReviewFilterInput: GraphQLMapConvertible {
  ...
  public init(id: ModelIDInput? = nil, user: ModelStringInput? = nil, recipeId: ModelIDInput? = nil, content: ModelStringInput? = nil, image: ModelStringInput? = nil, createdAt: ModelStringInput? = nil, updatedAt: ModelStringInput? = nil, and: [ModelReviewFilterInput?]? = nil, or: [ModelReviewFilterInput?]? = nil, not: ModelReviewFilterInput? = nil) {
    graphQLMap = ["id": id, "user": user, "recipeID": recipeId, "content": content, "image": image, "createdAt": createdAt, "updatedAt": updatedAt, "and": and, "or": or, "not": not]
  }
    ...
    public struct CreateRecipe: GraphQLSelectionSet {
      ...
      public struct Review: GraphQLSelectionSet {
        ...
        public struct Item: GraphQLSelectionSet {
          ...
          public init(id: GraphQLID, user: String, recipeId: GraphQLID, content: String, image: String, createdAt: String? = nil, updatedAt: String? = nil) {
...
public final class CreateReviewMutation: GraphQLMutation {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct CreateReview: GraphQLSelectionSet {
      ...
      public init(id: GraphQLID, user: String, recipeId: GraphQLID, content: String, image: String, recipe: Recipe? = nil, createdAt: String? = nil, updatedAt: String? = nil) {
...
public final class RecipesByFavQuery: GraphQLQuery {
  ...
  public init(type: String? = nil, favNum: ModelIntKeyConditionInput? = nil, sortDirection: ModelSortDirection? = nil, filter: ModelRecipeFilterInput? = nil, limit: Int? = nil, nextToken: String? = nil) {
    self.type = type
    self.favNum = favNum
    self.sortDirection = sortDirection
    self.filter = filter
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public static let selections: [GraphQLSelection] = [
      GraphQLField("recipesByFav", arguments: ["type": GraphQLVariable("type"), "favNum": GraphQLVariable("favNum"), "sortDirection": GraphQLVariable("sortDirection"), "filter": GraphQLVariable("filter"), "limit": GraphQLVariable("limit"), "nextToken": GraphQLVariable("nextToken")], type: .object(RecipesByFav.selections)),
    ]
    ...
    public init(recipesByFav: RecipesByFav? = nil) {
      self.init(snapshot: ["__typename": "Query", "recipesByFav": recipesByFav.flatMap { $0.snapshot }])
    }

    public var recipesByFav: RecipesByFav? {
      get {
        return (snapshot["recipesByFav"] as? Snapshot).flatMap { RecipesByFav(snapshot: $0) }
      }
      set {
        snapshot.updateValue(newValue?.snapshot, forKey: "recipesByFav")
      }
    }

    public struct RecipesByFav: GraphQLSelectionSet {
      public static let possibleTypes = ["ModelRecipeConnection"]
...
public final class RecipesByReviewQuery: GraphQLQuery {
  public static let operationString =
    "query RecipesByReview($type: String, $reviewNum: ModelIntKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelRecipeFilterInput, $limit: Int, $nextToken: String) {\n  recipesByReview(type: $type, reviewNum: $reviewNum, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      user\n      type\n      title\n      calorie\n      protein\n      fat\n      carbo\n      state\n      materials\n      contents {\n        __typename\n        nextToken\n      }\n      reviews {\n        __typename\n        nextToken\n      }\n      favNum\n      reviewNum\n      createdAt\n      updatedAt\n      delFlg\n    }\n    nextToken\n  }\n}"
  ...
  public init(type: String? = nil, reviewNum: ModelIntKeyConditionInput? = nil, sortDirection: ModelSortDirection? = nil, filter: ModelRecipeFilterInput? = nil, limit: Int? = nil, nextToken: String? = nil) {
    self.type = type
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public static let selections: [GraphQLSelection] = [
      GraphQLField("recipesByReview", arguments: ["type": GraphQLVariable("type"), "reviewNum": GraphQLVariable("reviewNum"), "sortDirection": GraphQLVariable("sortDirection"), "filter": GraphQLVariable("filter"), "limit": GraphQLVariable("limit"), "nextToken": GraphQLVariable("nextToken")], type: .object(RecipesByReview.selections)),
    ]
    ...
    public init(recipesByReview: RecipesByReview? = nil) {
      self.init(snapshot: ["__typename": "Query", "recipesByReview": recipesByReview.flatMap { $0.snapshot }])
    }

    public var recipesByReview: RecipesByReview? {
      get {
        return (snapshot["recipesByReview"] as? Snapshot).flatMap { RecipesByReview(snapshot: $0) }
      }
      set {
        snapshot.updateValue(newValue?.snapshot, forKey: "recipesByReview")
      }
    }

    public struct RecipesByReview: GraphQLSelectionSet {
      public static let possibleTypes = ["ModelRecipeConnection"]
...
public final class ByReviewQuery: GraphQLQuery {
  ...
  public init(recipeID: GraphQLID? = nil, createdAt: ModelStringKeyConditionInput? = nil, sortDirection: ModelSortDirection? = nil, filter: ModelReviewFilterInput? = nil, limit: Int? = nil, nextToken: String? = nil) {
    self.recipeID = recipeID
    self.createdAt = createdAt
    self.sortDirection = sortDirection
    self.filter = filter
  ...
  public var variables: GraphQLMap? {
    return ["recipeID": recipeID, "createdAt": createdAt, "sortDirection": sortDirection, "filter": filter, "limit": limit, "nextToken": nextToken]
  }
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public static let selections: [GraphQLSelection] = [
      GraphQLField("byReview", arguments: ["recipeID": GraphQLVariable("recipeID"), "createdAt": GraphQLVariable("createdAt"), "sortDirection": GraphQLVariable("sortDirection"), "filter": GraphQLVariable("filter"), "limit": GraphQLVariable("limit"), "nextToken": GraphQLVariable("nextToken")], type: .object(ByReview.selections)),
    ]
