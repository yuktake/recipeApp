...
//                .foregroundColor(Color.white.opacity(0.05))
                ...
                .gesture(
                    DragGesture()
                        .onChanged{drag in
//                            print(activeOffset.height)
                            // タッチしたところを０として相対的な位置を取得
...
//                .offset(
//                    x: activeOffset.width - (activeMagnification*getDimension(w: imageWidth, h: imageHeight)/2),
//                    y: activeOffset.height - (activeMagnification*getDimension(w: imageWidth, h: imageHeight)/2)
//                )
//                .padding(25)
//                .gesture(
//                    DragGesture()
...
////                            print(self.activeOffset.width)
////                            print(self.activeOffset.height)
//                            
